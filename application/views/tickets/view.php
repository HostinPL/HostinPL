		    ...
		    <div class="m-portlet m-portlet--full-height   m-portlet--unair">
			    <div class="m-portlet__body">
					...
					<div class="m-card-profile__details">
						...
						<a href="#" class="m-card-profile__email m-link">Открыт</a>
						<?php elseif($ticket['ticket_status'] == 2): ?> 
						<a href="#" class="m-card-profile__email m-link">Получен ответ</a>
						<?php endif; ?>
					</div>
				</div>	
				<ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
					...
					<li class="m-nav__item">
						<a onClick="sendAction(<?php echo $ticket['ticket_id'] ?>,'closed')" class="m-nav__link">
					...
					<li class="m-nav__item">
						<a href="/tickets/create" class="m-nav__link">
							...
							<span class="m-nav__link-text">Новый запрос</span>
						</a>
					</li>
					<li class="m-nav__item">
...
var inputText = $("#text"); 
		$("#form_pr").html("<img src=\"https://vk.com/images/upload_inv.gif\" style=\"margin: 5px;\">").show().delay(3000);
