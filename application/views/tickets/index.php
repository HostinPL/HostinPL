            ...
            <div class="m-portlet m-portlet--full-height   m-portlet--unair">
                <div class="m-portlet__body">
                    ...
                    <div class="m-card-profile__details">
                        <span class="m-card-profile__name">Мои запросы</span>
                    </div>
                </div>  
                <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                    ...
                    <li class="m-nav__item">
                        <a href="/tickets/create" class="m-nav__link">
                            <i class="m-nav__link-icon fa flaticon-add"></i>
                            <span class="m-nav__link-text">Создать запрос</span>
                        </a>
                    </li>
                    <li class="m-nav__item">
                    ...
                    <table class="table table-striped m-table"">
                        ...
                        <?php foreach($tickets as $item): ?> 
                            <tr> 
                                ...
                                <td><a href="/tickets/view/index/<?php echo $item['ticket_id'] ?>" data-container="body" data-toggle="m-popover" data-placement="top" data-content="Управление запросом" data-original-title="" title="" class="btn btn-outline-brand m-btn m-btn--icon m-btn--icon-only"><i class="fa fa-share"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?> 
                            <?php if(empty($tickets)): ?> 
                            <tr>
                                <td colspan="8" style="text-align: center;">На данный момент у вас нет запросов.</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
