                        ...
                        <div class="m-section__content">
                            <table class="table table-striped m-table">
                                ...
                                continue;
                                    ...
                                    <?if($q):?>    
                                    <tr onclick="redirect('/monitor/view/index/<?php echo $item['server_id']?>')">           
                                        <td>
                                            ...
                                            <?elseif($item['game_code'] == 'mta'):?>/application/public/img/monitor/mta.png
                                        ...
                                        <td><?php echo $q['hostname'] ?>
                                        <p style="margin: 0;">Карта: <?php echo $q['mapname'] ?></p>
                                        </td>
                                        ...
                                        <td><?php echo $item['location_ip'] ?>:<?php echo $item['server_port'] ?><br><?php echo $item['location_name'] ?></td>       
                                    </tr>
                                    <?endif;?>
                                    <?php endforeach; ?>
                                </tbody>
