                ...
                <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
					<div class="m-portlet__head">
						...
						<div class="m-portlet__head-tools">
							<a href="/admin/newscategory/create" class="btn btn-accent m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
			                ...
			                <div class="m-section__content">
				                <table class="table table-striped m-table">
					                ...
					                <tbody>
						                ...
						                <tr onClick="redirect('/admin/newscategory/edit/index/<?php echo $item['category_id'] ?>')">
