...
?>
	    ...
	    <style>
	    .pagination>li{display:inline}.pagination>li>a,.pagination>li>span{position:relative;float:left;padding:6px 12px;line-height:1.42857;text-decoration:none;color:#337ab7;background-color:#fff;border:1px solid #ddd;margin-left:-1px}.pagination>li:first-child>a,.pagination>li:first-child>span{margin-left:0;border-bottom-left-radius:4px;border-top-left-radius:4px}.pagination>li:last-child>a,.pagination>li:last-child>span{border-bottom-right-radius:4px;border-top-right-radius:4px}.pagination>li>a:hover,.pagination>li>a:focus,.pagination>li>span:hover,.pagination>li>span:focus{z-index:3;color:#23527c;background-color:#fff;border-color:#ddd}.pagination>.active>a,.pagination>.active>a:hover,.pagination>.active>a:focus,.pagination>.active>span,.pagination>.active>span:hover,.pagination>.active>span:focus{z-index:2;color:#fff;background-color:#337ab7;border-color:#337ab7;cursor:default}.pagination>.disabled>span,.pagination>.disabled>span:hover,.pagination>.disabled>span:focus,.pagination>.disabled>a,.pagination>.disabled>a:hover,.pagination>.disabled>a:focus{color:#6c8dae;background-color:#fff;border-color:#ddd;cursor:not-allowed}.pagination-lg>li>a,.pagination-lg>li>span{padding:10px 16px;font-size:18px;line-height:1.33333}.pagination-lg>li:first-child>a,.pagination-lg>li:first-child>span{border-bottom-left-radius:6px;border-top-left-radius:6px}.pagination-lg>li:last-child>a,.pagination-lg>li:last-child>span{border-bottom-right-radius:6px;border-top-right-radius:6px}.pagination-sm>li>a,.pagination-sm>li>span{padding:5px 10px;font-size:12px;line-height:1.5}.pagination-sm>li:first-child>a,.pagination-sm>li:first-child>span{border-bottom-left-radius:3px;border-top-left-radius:3px}.pagination-sm>li:last-child>a,.pagination-sm>li:last-child>span{border-bottom-right-radius:3px;border-top-right-radius:3px}
	    </style>
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__section ">
								<h4 class="m-menu__section-text"><?if($user_access_level == 3):?> Админ-Центр<?elseif($user_access_level == 2):?> Центр поддержки<?endif;?></h4>
							...
							<li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/servers" class="m-menu__link ">
                                    ...
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Игровые сервера</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								<a href="javascript:;" class="m-menu__link m-menu__toggle">
									<i class="m-menu__link-icon flaticon-computer"></i>
									<span class="m-menu__link-text">Центр поддержки</span>
									<i class="m-menu__ver-arrow la la-angle-right"></i>
								</a>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="/admin/tickets" class="m-menu__link ">
												...
												<span class="m-menu__link-text">Все запросы</span>
											</a>
										</li>
										<li class="m-menu__item " aria-haspopup="true">
											<a href="/admin/tickets/create" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
												<span class="m-menu__link-text">Написать клиенту</span>
											</a>
										</li>
										<?php if($user_access_level == 3):?>
										<li class="m-menu__item " aria-haspopup="true">
											<a href="/admin/ticketcategory" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
												<span class="m-menu__link-text">Все категории</span>
											</a>
										</li>
										<li class="m-menu__item " aria-haspopup="true">
											<a href="/admin/ticketcategory/create" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/infobox" class="m-menu__link ">
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/invoices" class="m-menu__link ">
                                    <i class="m-menu__link-icon flaticon-coins"></i>
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Платежи</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/waste" class="m-menu__link ">
                                    <i class="m-menu__link-icon flaticon-folder-2"></i>
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Операции пользователей</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/emailinfo" class="m-menu__link ">
                                    <i class="m-menu__link-icon flaticon-bell"></i>
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Рассылка E-mail</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
                                    ...
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/games" class="m-menu__link ">
                                                ...
                                                <span class="m-menu__link-text">Список игр</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/games/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить игру</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/locations" class="m-menu__link ">
                                                ...
                                                <span class="m-menu__link-text">Список локаций</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/locations/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить локацию</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle">
                                    ...
                                    <span class="m-menu__link-text">Дополнения</span>
                                    <i class="m-menu__ver-arrow la la-angle-right"></i>
                                </a>
                                <div class="m-menu__submenu ">
                                    <span class="m-menu__arrow"></span>
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/adaps" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Список дополнений</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/adaps/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить дополнения</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/checksys" class="m-menu__link ">
                                    <i class="m-menu__link-icon flaticon-exclamation-2"></i>
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Система</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle">
                                    ...
                                    <span class="m-menu__link-text">Промо</span>
                                    <i class="m-menu__ver-arrow la la-angle-right"></i>
                                </a>
                                <div class="m-menu__submenu ">
                                    <span class="m-menu__arrow"></span>
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/promo" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Список промо кодов</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/promo/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить промо код</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle">
                                    <i class="m-menu__link-icon flaticon-music-1"></i>
                                ...
                                <div class="m-menu__submenu ">
                                    ...
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/news" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Список новостей</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/news/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить новость</span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/newscategory" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Все категории</span>
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="/admin/newscategory/create" class="m-menu__link ">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                <span class="m-menu__link-text">Добавить категорию</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/smsinfo" class="m-menu__link ">
                                    <i class="m-menu__link-icon flaticon-paper-plane"></i>
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Рассылка SMS</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/admin/settings" class="m-menu__link ">
                            ...
                            <li class="m-menu__item" aria-haspopup="true">
                                <a href="/main/index" class="m-menu__link ">
                                    ...
                                    <span class="m-menu__link-title">
                                        <span class="m-menu__link-wrap">
                                            <span class="m-menu__link-text">Выход из админ панели</span>
                                            <span class="m-menu__link-badge">
                                            </span>
                                        </span>
                                    </span>
