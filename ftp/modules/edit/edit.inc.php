...
// Detect the original encoding of the text, and change the encoding of the text to the encoding of the page
			//if (($net2ftp_globals["language"] == "ja" || $net2ftp_globals["language"] == "tc" || $net2ftp_messages["iso-8859-1"] == "UTF-8") && function_exists("mb_detect_encoding") == true) {
				...
				if($text_encoding_old != "" && strcasecmp($text_encoding_old, $net2ftp_messages["utf8"]) != 0) {
					$text = mb_convert_encoding($text, $net2ftp_messages["utf8"], $text_encoding_old);
				}
...
// Change the encoding of the text from the original or page encoding to the selected encoding
		...
		if (($net2ftp_globals["language"] == "ja" || $net2ftp_globals["language"] == "tc" || $net2ftp_messages["iso-8859-1"] == "UTF-8") && function_exists("mb_detect_encoding") == true) {
			...
			if($text_encoding_new != "" && strcasecmp($text_encoding_new, $net2ftp_messages["utf8"]) != 0) {
				$text_file = mb_convert_encoding($text_file, $text_encoding_new, $net2ftp_messages["utf8"]);
			}
...
// Convert *htm* to html
	...
	echo "<option value=\"plain\" $plainselected>Default</option>\n";
...
// --------------
	...
	elseif ($net2ftp_globals["language"] == "tc" || $net2ftp_globals["language"] == "zh" || $net2ftp_globals["language"] == "ru") {
		$textarea_encodings[] = "UTF-8";
